$(document).ready(function () {
  ...
  $("#project-title-1").hover(
    function () {
      ...
      overlay1.fadeIn(500);
      portfolioLink.attr("href", "projects/30-30.html"); // Change href for Project 1
    }
  );
  ...
  $("#project-title-2").hover(
    function () {
      ...
      overlay3.fadeOut(500);
      overlay2.fadeIn(500);
      portfolioLink.attr("href", "projects/susan-rodgers.html"); // Change href for Project 2
    }
  );
  ...
  $("#project-title-3").hover(
    function () {
      ...
      overlay2.fadeOut(500);
      overlay3.fadeIn(500);
      portfolioLink.attr("href", "projects/lil-wood-diner.html"); // Change href for Project 3
    }
  );
});
